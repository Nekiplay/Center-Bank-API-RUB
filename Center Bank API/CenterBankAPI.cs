...
using System.Net;
using static Center_Bank_API.CenterBankAPI.Currency;

namespace Center_Bank_API
{
    public class CenterBankAPI
    {
        public void Get()
        {
            ...
            {
                string json = client.DownloadString("https://www.cbr-xml-daily.ru/daily_json.js");
